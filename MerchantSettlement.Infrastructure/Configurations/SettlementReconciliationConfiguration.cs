...
public class SettlementReconciliationConfiguration : IEntityTypeConfiguration<SettlementReconciliation>
{
    public void Configure(EntityTypeBuilder<SettlementReconciliation> builder)
    {
        builder.ToTable("SettlementReconciliations");
